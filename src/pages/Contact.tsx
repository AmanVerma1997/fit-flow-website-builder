          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {contactMethods.map((method, index) => (
              <Card key={index} className="hover-lift bg-white border-0 shadow-lg text-center">
                ...
                <CardContent>
                  <Button asChild className="w-full bg-accent hover:bg-accent/90 font-semibold text-white">
                    <a href={method.link} className="flex items-center justify-center">
                      {method.action}
                    </a>
                  </Button>
                </CardContent>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-accent hover:bg-accent/90 font-semibold text-white">
              <a href="tel:+917973848128">Call +91 7973848128</a>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-white hover:bg-white hover:text-primary font-semibold text-white">
              <a href="mailto:trainwithajayverma@gmail.com?subject=Free%20Consultation%20Request&body=Hi%20Ajay,%0A%0AI%20would%20like%20to%20book%20a%20free%20consultation%20to%20discuss%20my%20fitness%20goals.%0A%0APlease%20let%20me%20know%20your%20available%20time%20slots.%0A%0AThank%20you!">
